...
Pre/post splits use **trade date** cutoffs and **pitcher team** derived from `inning_topbot` + home/away. Shape metrics include arm angle, release point, spin, extension, movement, and API break fields beyond the arsenal outcome model. Pairing/tunnel notes reuse `pair_velo_sep`, `pair_mov_sep`, and release-distance logic from `arsenal.py`.
...
**Pre-trade**
- CH vs primary FF: velo sep 9.4 mph, move sep 1.3 in, release distinct release (0.49 ft)
- SI vs primary FF: velo sep 0.0 mph, move sep 0.9 in, release strong tunnel (0.19 ft)
- SL vs primary FF: velo sep 7.4 mph, move sep 1.2 in, release distinct release (0.50 ft)
- CU vs primary FF: velo sep 16.5 mph, move sep 2.1 in, release strong tunnel (0.19 ft)

**Post-trade**
- CH vs primary SI: velo sep 9.1 mph, move sep 0.6 in, release moderate tunnel (0.39 ft)
- FF vs primary SI: velo sep 0.3 mph, move sep 0.9 in, release strong tunnel (0.19 ft)
- SL vs primary SI: velo sep 6.4 mph, move sep 1.4 in, release moderate tunnel (0.32 ft)
- CU vs primary SI: velo sep 16.4 mph, move sep 2.2 in, release strong tunnel (0.10 ft)
...
**Pre-trade**
- FS vs primary FF: velo sep 9.9 mph, move sep 1.1 in, release strong tunnel (0.22 ft)
- SL vs primary FF: velo sep 9.7 mph, move sep 1.5 in, release strong tunnel (0.19 ft)

**Post-trade**
- FF vs primary FS: velo sep 9.2 mph, move sep 1.0 in, release moderate tunnel (0.25 ft)
- SL vs primary FS: velo sep 0.4 mph, move sep 1.1 in, release strong tunnel (0.15 ft)
...
**Pre-trade**
- KC vs primary SI: velo sep 11.1 mph, move sep 2.4 in, release moderate tunnel (0.31 ft)
- FF vs primary SI: velo sep 0.8 mph, move sep 0.9 in, release strong tunnel (0.02 ft)
- FS vs primary SI: velo sep 4.0 mph, move sep 0.2 in, release strong tunnel (0.03 ft)
- SL vs primary SI: velo sep 6.2 mph, move sep 1.3 in, release strong tunnel (0.15 ft)

**Post-trade**
- KC vs primary SI: velo sep 10.2 mph, move sep 2.5 in, release moderate tunnel (0.36 ft)
- FF vs primary SI: velo sep 0.6 mph, move sep 0.9 in, release strong tunnel (0.02 ft)
- FS vs primary SI: velo sep 3.8 mph, move sep 0.1 in, release strong tunnel (0.07 ft)
...
**Pre-trade**
- SL vs primary FF: velo sep 5.8 mph, move sep 1.5 in, release moderate tunnel (0.41 ft)
- FS vs primary FF: velo sep 5.6 mph, move sep 1.1 in, release strong tunnel (0.21 ft)
- SI vs primary FF: velo sep 0.1 mph, move sep 0.4 in, release strong tunnel (0.07 ft)
- SV vs primary FF: velo sep 12.0 mph, move sep 2.8 in, release distinct release (0.50 ft)

**Post-trade**
- SL vs primary FF: velo sep 5.7 mph, move sep 1.6 in, release moderate tunnel (0.38 ft)
- FS vs primary FF: velo sep 5.0 mph, move sep 1.1 in, release strong tunnel (0.19 ft)
- SI vs primary FF: velo sep 0.5 mph, move sep 0.4 in, release strong tunnel (0.06 ft)
- SV vs primary FF: velo sep 11.8 mph, move sep 2.7 in, release distinct release (0.46 ft)
...
**Pre-trade**
- CH vs primary FF: velo sep 6.9 mph, move sep 1.4 in, release moderate tunnel (0.44 ft)
- CU vs primary FF: velo sep 14.9 mph, move sep 1.9 in, release strong tunnel (0.07 ft)
- ST vs primary FF: velo sep 12.4 mph, move sep 1.8 in, release strong tunnel (0.21 ft)
- SL vs primary FF: velo sep 11.0 mph, move sep 1.4 in, release moderate tunnel (0.35 ft)
- CS vs primary FF: velo sep 19.2 mph, move sep 2.5 in, release strong tunnel (0.06 ft)

**Post-trade**
- CH vs primary FF: velo sep 6.8 mph, move sep 1.2 in, release moderate tunnel (0.32 ft)
- CU vs primary FF: velo sep 14.3 mph, move sep 1.8 in, release strong tunnel (0.12 ft)
- ST vs primary FF: velo sep 11.5 mph, move sep 1.6 in, release strong tunnel (0.20 ft)
